        ...
        <div class="row">
            ...
            <div class="col-10">
                ...
                <div class="box">
                   ...
                   <button onclick="location.href='admin_vendor.php'" class="button"><b>Seller</b></button>
                   <br>
                    
                    <button onclick="location.href='admin_consumer.php'" class="button"><b>Customer</b></button>
